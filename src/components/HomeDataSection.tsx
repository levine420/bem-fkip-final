      ...
      <div className="relative mx-auto max-w-7xl">
        ...
        {eventList.length === 0 ? (
          ...
          <div className="mt-10 grid gap-6 sm:grid-cols-2">
            {eventList.map((ev) => (
              <div key={ev.id} className="glass rounded-3xl overflow-hidden transition duration-300 hover:border-accent/50 flex flex-col justify-between p-6">
                <div>
                  <div className="flex items-center justify-between gap-2 mb-3">
                    ...
                    <span className={`text-xs font-bold px-3 py-1 rounded-full ${
                      ...
                      {ev.registration_status === "TERBUKA" ? "Pendaftaran Terbuka" : "Tutup / Segera"}
                    </span>
                  </div>
                ...
                <div className="mt-6 pt-4 border-t border-glass-border flex flex-wrap items-center justify-between gap-4 text-xs">
                  ...
                  <Link href={`/kegiatan/kalender`} className="focus-ring rounded-xl bg-brand px-4 py-2 text-xs font-semibold text-white hover:bg-brand-hover">
                    Detail Acara
                  </Link>
                </div>
              </div>
